...
define('API_KEY',"7050450657:AAF9OJLne07OlQrFqW7YNy6DjbSaK3VN9bo");//Token yozasiz

$shakh_akn = "6894538396";//asosiy admin
$admin = array("$shakh_akn","6894538396","6894538396");//adminlar
...
$username = "holidcoder_kinobot"; //mysql baza nomi
$password = "kinobot"; //mysql baza paroli
...
if(file_get_contents("kino_ch.txt")){
		...
		if(file_put_contents("kino_ch.txt","@HOLID_CODER"));
}
